...
CREATE OR REPLACE TYPE T_PanierTab AS TABLE OF T_Panier;
...
INSERT INTO Article VALUES ('A1', 'MacPro', 'Rouge', Categorie(1, 'Apple'), 1.50, 500);
INSERT INTO Article VALUES ('A2', 'MacPro Air', 'Blanc', Categorie(1, 'Apple'), 1.50, 800);
INSERT INTO Article VALUES ('A3', 'MacPro Server', 'Noir', Categorie(1, 'Apple'), 2.00, 1000);
INSERT INTO Article VALUES ('A4', 'Dell', 'Jaune', Categorie(2, 'PC'), 1500, 1);
INSERT INTO Article VALUES ('A5', 'HP', 'Bleu', Categorie(1, 'Apple'), 10.00, 200);
INSERT INTO Article VALUES ('A6', 'Acer', 'Gris', Categorie(3, 'Autre'), 10.00, 25);
INSERT INTO Article VALUES ('A7', 'Sony', 'Noir', Categorie(2, 'PC'), 120, 300);
